...
.data
file_in:	.asciiz "input.txt"	# Reemplace esta cadena con el nombre del archivo que desea abrir para ser leído
file_out:	.asciiz "output.txt"	# Este es el nombre del archivo de salida
					# Ambos archivos residen en la misma carpeta de MARS
sentence:	.byte 0x0D, 0x0A, 0x0D, 0x0A	# 0x0D: Ascii para retorno de carro. 0x0A: Ascii para salto de línea
