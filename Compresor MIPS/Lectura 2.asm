...
sentence:	.byte 0x0D, 0x0A, 0x0D, 0x0A	# 0x0D: Ascii para retorno de carro. 0x0A: Ascii para salto de línea  0x0D, 0x0A, 0x0D, 0x0A
sentence_cont:	.asciiz "???YosoyLaSentecia????"
